...
let coxinha = prompt("Deseja comer mais coxinha? (S/N)").toUpperCase()
let conta = 0
while(coxinha === "S"){
    conta = conta + 2.50
    coxinha = prompt("Deseja comer mais coxinha? (S/N)").toUpperCase()
}
console.log("A conta total foi de R$ ",conta)